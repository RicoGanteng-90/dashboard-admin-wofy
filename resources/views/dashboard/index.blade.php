    ...
    <section class="section dashboard">
          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
                <div class="card info-card revenue-card">
                  ...
                  <div class="card-body">
                    <h5 class="card-title">Lunas <span>| This Month</span></h5>
            ...
            <div class="col-xxl-4 col-xl-6">
                ...
                <div class="card info-card customers-card">
                  ...
                  <div class="card-body">
                    <h5 class="card-title">Belum lunas <span>| This Year</span></h5>
            ...
            <div class="col-xxl-4 col-xl-6">
                ...
                <div class="card info-card customers-card">
                  ...
                  <div class="card-body">
                    <h5 class="card-title">Lunas <span>| This Year</span></h5>
      ...
      <!-- End Admin Card -->
            ...
            <div class="col-xxl-4 col-xl-6">
                ...
                <div class="card-body">
                    <h5 class="card-title">Customer <span>| This Year</span></h5>
        ...
        <!-- End Admin Card -->
            ...
            <div class="col-xxl-4 col-xl-6">
                ...
                <div class="card-body">
                    <h5 class="card-title">Partner <span>| This Year</span></h5>
        ...
        <!-- End Partner Card -->
            ...
            <div class="col-xxl-4 col-xl-6">
                ...
                <div class="card-body">
                    <h5 class="card-title">Message <span>| This Year</span></h5>
